...
{
    public sealed class PriorityEventLog : Panel
    {
        public IApp App;
        public IPTS PTS;
        ...
        public PriorityEventLog()
        {
            Localization = new Dictionary<String, String>
            {
                {"EventPanel_EventNo", "No. %1"},
                {"EventPanel_Priority", "Priority {0}"},
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                var priorityString = string.Format(Localization["EventPanel_Priority"], CameraEvent.GetPriority());
                g.DrawString(priorityString + Environment.NewLine +
                             info + _eventStr + Environment.NewLine + _dateTime, _font, _brush, 22, 9);
