    ...
    public sealed partial class ListPanel : UserControl
    {
        ...
        public ListPanel()
        {
            Localization = new Dictionary<String, String>
                               {
                                   {"SetupEvent_AddNewExceptionReport", "Add new exception report..."},
                                   {"SetupEvent_AddedEventReport", "Added exception report"},
                               };
            ...
            addedExceptionReportLabel.Text = Localization["SetupEvent_AddedEventReport"];
        }
        ...
        private void InputPanelPaint(Object sender, PaintEventArgs e)
        {
            ...
            Manager.PaintText(g, Localization["SetupEvent_AddNewExceptionReport"]);
        }
        ...
        public void GenerateViewModel()
        {
            ...
            addedExceptionReportLabel.Visible = false;

            if (POS.ExceptionReports.Count == 0) return;

            addedExceptionReportLabel.Visible = true;
        ...
        {
            addNewDoubleBufferPanel.Visible = addedExceptionReportLabel.Visible = false;
