...
{
	public sealed partial class ExceptionPercentage : UserControl, IControl, IAppUse, IServerUse, IBlockPanelUse
	{
		...
		public ExceptionPercentage()
		{
			Localization = new Dictionary<String, String>
							   {
								   {"Control_ReportExceptionPercentage", "Exception Percentage"},
			...
			Name = "ReportExceptionPercentage";
			TitleName = Localization["Control_ReportExceptionPercentage"];
		...
		public void SelectionChange(Object sender, EventArgs<String> e)
		{
			...
			switch (item)
			{
				case "SearchException":
					...
					{
						ShowCriteriaPanel();
						CriteriaPanel.SearchCashierExceptionPercentageReport();
					}
					break;
