...
{
	public sealed partial class Cashier : UserControl, IControl, IAppUse, IServerUse, IBlockPanelUse
	{
		...
		public Cashier()
		{
			...
			Name = "ReportCashier";
			TitleName = Localization["Control_ReportCashier"];
