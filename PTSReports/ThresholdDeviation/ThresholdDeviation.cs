...
{
	public sealed partial class ThresholdDeviation : UserControl, IControl, IAppUse, IServerUse, IBlockPanelUse
	{
		...
		public ThresholdDeviation()
		{
			Localization = new Dictionary<String, String>
							   {
								   {"MessageBox_Information", "Information"},
								   {"Control_ReportThresholdDeviation", "Threshold Deviation"},
			...
			Name = "ReportThresholdDeviation";
			TitleName = Localization["Control_ReportThresholdDeviation"];
		...
		private void CriteriaPanelOnExceptionSearchCriteriaChange(Object sender, EventArgs<ExceptionReportParameter> e)
		{
			...
			switch (item)
			{
				case "SearchException":
					if (_focusReport == this)
					{
						...
						ShowCriteriaPanel();
						CriteriaPanel.SearchExceptionThresholdDeviationReport();
					}
					break;
