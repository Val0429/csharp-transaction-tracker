...
{
	public sealed partial class ScheduleReportEditPanel : UserControl
	{
		public IPTS PTS;
		...
		public ScheduleReportEditPanel()
		{
			...
			_dailyCheckBoxDic.Add(6, sunCheckBox);
			_dailyCheckBoxDic.Add(0, monCheckBox);
			_dailyCheckBoxDic.Add(1, tueCheckBox);
			_dailyCheckBoxDic.Add(2, wedCheckBox);
			_dailyCheckBoxDic.Add(3, thuCheckBox);
			_dailyCheckBoxDic.Add(4, friCheckBox);
			_dailyCheckBoxDic.Add(5, satCheckBox);
