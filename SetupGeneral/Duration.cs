...
{
    public sealed partial class DurationControl : UserControl
    {
        ...
        public DurationControl()
        {
            Localization = new Dictionary<String, String>
                               {
                                   ...
                                   {"SetupGeneral_RecordDurationValue", "Record duration should between %1 secs to %2 hour"},
                               };
            ...
            DoubleBuffered = true;
            Dock = DockStyle.None;
            Name = "ManualRecordDuration";
            BackgroundImage = Manager.BackgroundNoBorder;
            customPanel.Paint += DurationInputPanelPaint;
            infoLabel.Text = Localization["SetupGeneral_RecordDurationValue"].Replace("%1", MiniumDuration.ToString()).Replace("%2", (MaximumDuration / 3600).ToString());
        ...
        public void ParseSetting()
        {
            ...
            durationTextBox.Text = Server.Configure.ManualRecordDuration.ToString();
            
            durationTextBox.TextChanged += DurationTextBoxTextChanged;
        }

        private readonly UInt16[] _durationArray = new UInt16[] { 60, 120, 180, 300, 600, 900, 1800, 3600};
        public void Initialize()
        {
            foreach (UInt16 duration in _durationArray.Reverse())
            {
                ...
                durationPanel.MouseClick += DurationPanelMouseClick;

                containerPanel.Controls.Add(durationPanel);
            }
        }

        private void DurationPanelMouseClick(Object sender, MouseEventArgs e)
        {
            Server.Configure.ManualRecordDuration = Convert.ToUInt16(((Control)sender).Tag);
        ...
        private void DurationInputPanelPaint(Object sender, PaintEventArgs e)
        {
            ...
            if (!_durationArray.Contains(Server.Configure.ManualRecordDuration))
            {
        ...
        private void DurationTextBoxTextChanged(Object sender, EventArgs e)
        {
            ...
            Server.Configure.ManualRecordDuration = Convert.ToUInt16(Math.Min(Math.Max(duration, MiniumDuration), MaximumDuration));

            Invalidate();
        }
    }

    public sealed class DurationPanel : Panel
    {
        public IServer Server;
        public Dictionary<String, String> Localization;
        ...
        public DurationPanel()
        {
            ...
            Paint += DurationPanelPaint;
        }

        private String _duration;
        private void DurationPanelPaint(Object sender, PaintEventArgs e)
        {
            ...
            if (Width <= 100) return;
            if (Tag.ToString() == Server.Configure.ManualRecordDuration.ToString())
            {
