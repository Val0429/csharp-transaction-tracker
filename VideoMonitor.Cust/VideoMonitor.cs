...
using System.Xml;
using App_ConfigurationToOrder;
using Constant;
using Interface;
using VM = VideoMonitor;

namespace VideoMonitor.Cust
{
    public partial class VideoMonitor : VM.VideoMonitor
    {
        ...
        private DateTime _stopRecordTime;
        ...
        public void StopInterrogationRecord(Object sender, EventArgs<String, DateTime, String> e )
        {
            ...
            ((ConfigurationToOrder) App).ExportVideoWithInfo(new IDevice[]{cam}, _startRecordTime, _stopRecordTime, xml);
        }
    }
}
