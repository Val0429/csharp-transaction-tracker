    ...
    public sealed class ExceptionPanel : Panel
    {
        ...
        public POS_Exception.Exception Exception
        {
            ...
            set
            {
                ...
                _tagTextBox.Text = _exception.Key;
                _tagTextBox.Enabled = _exception.Editable;
                ...
                _tagEndTextBox.Text = _exception.TagEnd;
                _tagEndTextBox.Enabled = _exception.Editable;
                _isEditing = true;
            }
        }
        ...
        private void TagTextBoxTextChanged(object sender, EventArgs e)
        {
            ...
            _exception.Key = _tagTextBox.Text;
        }
        ...
        private void TagEndTextBoxTextChanged(object sender, EventArgs e)
        {
            ...
            _exception.TagEnd = _tagEndTextBox.Text;
        }
