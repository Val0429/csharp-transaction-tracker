...
namespace PanelBase
{
    public static partial class Manager
    {
        ...
        public static readonly Color DeleteColor = Color.FromArgb(237, 57, 28);
        public static readonly Color SelectedColor = Color.FromArgb(77, 177, 224);
        public static readonly Brush DeleteTextColor = new SolidBrush(DeleteColor); //Brushes.RoyalBlue
        public static readonly Brush SelectedTextColor = new SolidBrush(SelectedColor); //Brushes.RoyalBlue
        ...
        public static void PaintSingleInput(Graphics graphics, Control control, Int32 height, Int32 width)
        {
            ...
            graphics.FillRectangle(InputBrush, TopLeftRound.Width, TopBorder.Height, width - TopLeftRound.Width - TopRightRound.Width, height);
            graphics.DrawImage(InputTopBorder, TopLeftRound.Width, 0, width - TopLeftRound.Width - TopRightRound.Width, TopBorder.Height);
            graphics.DrawImage(InputBottomBorder, BottomLeftRound.Width, height - BottomBorder.Height, width - BottomLeftRound.Width - BottomRightRound.Width, BottomBorder.Height);

            graphics.DrawImage(InputLeftBorder, 0, TopLeftRound.Height, LeftBorder.Width, height - TopLeftRound.Height - BottomLeftRound.Height);
            graphics.DrawImage(InputTopLeftRound, 0, 0, TopLeftRound.Width, TopLeftRound.Height);
            graphics.DrawImage(InputBottomLeftRound, 0, height - BottomLeftRound.Height, BottomLeftRound.Width, BottomLeftRound.Height);

            graphics.DrawImage(InputRightBorder, width - RightBorder.Width, TopRightRound.Height, RightBorder.Width, height - TopRightRound.Height - BottomRightRound.Height);
            graphics.DrawImage(InputTopRightRound, width - TopRightRound.Width, 0, TopRightRound.Width, TopRightRound.Height);
            graphics.DrawImage(InputBottomRightRound, width - BottomRightRound.Width, height - BottomRightRound.Height, BottomRightRound.Width, BottomRightRound.Height);
        }
        ...
        public static void PaintTitleText(Graphics graphics, String text, int x = 44, int y = 13)
        {
            if (String.IsNullOrEmpty(text)) return;
            PaintText(graphics, text, TitleTextColor, x, y);
        }
