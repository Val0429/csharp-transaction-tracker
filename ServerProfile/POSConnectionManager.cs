...
namespace ServerProfile
{
    public partial class POSManager
    {
        ...
        private XmlDocument ParseConnectionToXml(IPOSConnection connection)
        {
            ...
            xmlRoot.AppendChild(Xml.CreateXmlElementWithText(xmlDoc, "Manufacture", connection.Manufacture));
            ...
            connection.POS.Sort((x, y) => (x.Id - y.Id));
        ...
        public UInt16 GetNewConnectionId()
        {
