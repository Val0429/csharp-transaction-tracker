...
namespace ServerProfile
{
    ...
    {
        public POS_Exception.TransactionList ReadTransactionHeadByCondition(UInt16 posId, UInt64 startutc, UInt64 endutc, String searchText, Int32 pageIndex, UInt16 count)
        {
        ...
        public POS_Exception.TransactionList ReadTransactionHeadByCondition(UInt16[] posIds, String[] cashierIds, UInt64 startutc, UInt64 endutc,
