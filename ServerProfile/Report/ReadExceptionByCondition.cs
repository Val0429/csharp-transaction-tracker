...
namespace ServerProfile
{
    ...
    {
        public POS_Exception.ExceptionDetailList ReadExceptionByCondition(UInt16 posId, UInt64 startutc, UInt64 endutc, String searchText, Int32 pageIndex, UInt16 count)
        {
        ...
        public POS_Exception.ExceptionDetailList ReadExceptionByCondition(UInt16[] posIds, String[] cashierIds, String[] cashiers, UInt64 startutc, UInt64 endutc, String[] exceptions, String[] keywords, Int32 pageIndex, UInt16 count)
        {
            CheckDateTimeDontGoToFar(ref startutc, ref endutc);
