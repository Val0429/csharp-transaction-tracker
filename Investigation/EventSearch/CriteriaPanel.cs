...
{
    public partial class CriteriaPanel : UserControl
    {
            ...
            switch (SearchCriteria.DateTimeSet)
            {
                ...
                default:
                    Manager.PaintTextRight(g, dateTimeDoubleBufferPanel,
                        DateTimes.ToDateTime(SearchCriteria.StartDateTime, NVR.Server.TimeZone).ToDateTimeString() + @" ~ " +
                        DateTimes.ToDateTime(SearchCriteria.EndDateTime, NVR.Server.TimeZone).ToDateTimeString());
                    break;
            }
        }
