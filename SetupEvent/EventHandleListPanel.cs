...
{
    public partial class EventHandleListPanel : UserControl
    {
        ...
        public virtual void GenerateViewModel()
        {
            ...
            AddEventHandlePanel(Camera.EventHandling.GetEventCondition(EventType.Panic));
            AddEventHandlePanel(Camera.EventHandling.GetEventCondition(EventType.CrossLine));

            AddEventHandlePanel(Camera.EventHandling.GetEventCondition(EventType.IntrusionDetection));
            AddEventHandlePanel(Camera.EventHandling.GetEventCondition(EventType.LoiteringDetection));
            AddEventHandlePanel(Camera.EventHandling.GetEventCondition(EventType.ObjectCountingIn));
            AddEventHandlePanel(Camera.EventHandling.GetEventCondition(EventType.ObjectCountingOut));

            AddEventHandlePanel(Camera.EventHandling.GetEventCondition(EventType.AudioDetection));
            AddEventHandlePanel(Camera.EventHandling.GetEventCondition(EventType.TamperDetection));
        ...
        protected void AddEventHandlePanel(EventCondition condition)
        {
        ...
        protected virtual EventHandlePanel GetEventHandlePanel()
        {
        ...
        protected void EventHandlePanelOnHandleChange(Object sender, EventArgs e)
        {
            CameraIsModify();
        }
        ...
        protected virtual void EventHandlePanelOnEventEditClick(Object sender, EventArgs e)
        {
