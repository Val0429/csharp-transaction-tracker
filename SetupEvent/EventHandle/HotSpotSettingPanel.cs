...
{
	public sealed class HotSpotSettingPanel : Panel
	{
		public HandlePanel HandlePanel;
		public Dictionary<String, String> Localization;

		private HotSpotEventHandle _eventHandle;
		public HotSpotEventHandle EventHandle
		{
			set
			{
				_eventHandle = value;
