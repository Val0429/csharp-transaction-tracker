...
{
    public sealed class PopupPlaybackSettingPanel : Panel
    {
        public HandlePanel HandlePanel;
        public Dictionary<String, String> Localization;

        private PopupPlaybackEventHandle _eventHandle;
        public PopupPlaybackEventHandle EventHandle
        {
            set
            {
                _eventHandle = value;
        ...
        public PopupPlaybackSettingPanel()
        {
