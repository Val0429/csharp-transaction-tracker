...
namespace App_CentralManagementSystem
{
    public partial class CentralManagementSystem
	{
		...
		{
            StartupOption.Doamin = CMS.Credential.Domain;
            StartupOption.Port = CMS.Credential.Port.ToString();
            StartupOption.Account = CMS.Credential.UserName;
            StartupOption.Password = CMS.Credential.Password;
            StartupOption.SSLEnable = CMS.Credential.SSLEnable;
