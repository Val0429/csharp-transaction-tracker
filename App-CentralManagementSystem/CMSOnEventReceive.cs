...
namespace App_CentralManagementSystem
{
    public partial class CentralManagementSystem
    {
        ...
        private void CMSOnEventReceive(Object sender, EventArgs<List<ICameraEvent>> e)
        {
        ...
        private void Beep(EventHandle eventHandle)
        {
            ...
            {
                CMS.Utility.PlaySystemSound(beepEventHandle.Times,
        ...
        private void PopupInstantPlayback(EventHandle eventHandle)
        {
            ...
            {
                PopupInstantPlayback(popupPlaybackEventHandle.Device, DateTimes.ToUtc(CMS.Server.DateTime, CMS.Server.TimeZone));
            }
        }
